...
const [isSettingsModalVisible, setIsSettingsModalVisible] = useState(false);
 ...
 useEffect(() => {
  ...
  return (
    <ImageBackground 
    source={require('../../assets/background/desktop.png')} 
...
overlayButtonsContainer: {
  ...
  timerTextContainer: {
    ...
    alignItems: 'center',
    marginBottom: 50,
    shadowColor: '#000', // Shadow for the text
  ...
  timeText: {
    ...
    fontWeight: 'bold',
    color: '#fff', // Assuming a dark background, white color for text
